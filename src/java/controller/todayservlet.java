...
public class todayservlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            List<Task> list = t.searchTaskbyDueDate(dueDate, u.getEmail());
            session.setAttribute("today", list);
            request.getRequestDispatcher("view/today.jsp").forward(request, response);
